...
public class AdventureGameApp extends Application {
    ...
    * to call "launch" which will in turn call "start" ...
    ...
    public void start(Stage primaryStage) throws IOException {
        this.model = new AdventureGame("C:\\Users\\sherl\\Documents\\Programming\\Java\\CSC207\\group_83\\Sherlock\\Games\\TinyGame"); //change the name of the game if you want to try something bigger!
