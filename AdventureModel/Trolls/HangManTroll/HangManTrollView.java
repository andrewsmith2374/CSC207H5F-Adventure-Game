...
public class HangManTrollView {
    private final HangManTroll model;
    ...
    public HangManTrollView(HangManTroll model) {
        this.model = model;
    ...
    public void chooseWord() {
        ...
        String filePath = "AdventureModel/Trolls/HangManTroll/random-words.txt";
