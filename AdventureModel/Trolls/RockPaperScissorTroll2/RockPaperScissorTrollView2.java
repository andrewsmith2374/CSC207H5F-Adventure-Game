...
public class RockPaperScissorTrollView2 {
    private Stage stage;
    private Button helpButton;
    private boolean helpToggle;
    private Label help;
    private RockPaperScissorTroll2 model;
    ...
    public RockPaperScissorTrollView2(RockPaperScissorTroll2 model) {
        this.model = model;
    ...
    private void intiUI() {
        ...
        rockView.setImage(new Image("AdventureModel/Trolls/RockPaperScissorTroll2/rock.png"));
        rockView.setId("rock");
        rockView.setFitWidth(300);
        rockView.setFitHeight(300);
        paperView.setImage(new Image("AdventureModel/Trolls/RockPaperScissorTroll2/paper.png"));
        paperView.setId("paper");
        paperView.setFitWidth(300);
        paperView.setFitHeight(300);
        scissorView.setImage(new Image("AdventureModel/Trolls/RockPaperScissorTroll2/scissors.png"));
        scissorView.setId("scissor");
        scissorView.setFitHeight(300);
        scissorView.setFitWidth(300);

        compRock.setImage(new Image("AdventureModel/Trolls/RockPaperScissorTroll2/rock.png"));
        compRock.setId("rock");
        compRock.setFitWidth(300);
        compRock.setFitHeight(300);
        compPaper.setImage(new Image("AdventureModel/Trolls/RockPaperScissorTroll2/paper.png"));
        compPaper.setId("paper");
        compPaper.setFitHeight(300);
        compPaper.setFitWidth(300);
        compScissor.setImage(new Image("AdventureModel/Trolls/RockPaperScissorTroll2/scissors.png"));
